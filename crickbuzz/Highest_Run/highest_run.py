...
select.select_by_visible_text("T20I")

driver.find_element(By.XPATH,"//a[normalize-space()= 'Highest Scores']").click()
...
#    EC.presence_of_element_located((By.XPATH, "//strong[text()='Match Types']/..//select")))


with open('t20_highest_runs.csv', 'w', newline='', encoding='utf-8') as file:
